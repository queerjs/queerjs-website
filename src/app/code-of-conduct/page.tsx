      ...
      <main className="mb-10">
        ...
        <Panel heading="Code of Conduct">
          <section className="leading-normal">
            <p>
              All attendees, speakers, sponsors and volunteers at QueerJS meetup
              are required to agree with the following code of conduct.
            </p>
            <p>
              Organizers enforce this code throughout the event. We expect
              cooperation from all participants to help ensure a safe
              environment for everybody.
            </p>
            <p>
              {" "}
              <Link href="/report" title="Code of Conduct">
                Report an Issue
              </Link>
              .
            </p>
            ...
            <p>
              Here at QueerJS meetup, we are dedicated to providing a
              harassment-free meetup experience for everyone, regardless of
            ...
            <p>
              ...
              We ask that all attendees are mindful of their surroundings and of
              their fellow participants.
            </p>
            <br />
            <p>
              Meetup attendees violating these rules will be expelled from the
              meetup.
            </p>
            ...
            <p>
              If a participant engages in harassing behaviour, the meetup
            ...
            <p>
              ...
              any other concerns, please notify a QueerJS organizer as soon as
              possible.
            </p>
            <p>
            ...
            <p>
              Meetup staff are happy to help participants and assist people
