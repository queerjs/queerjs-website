...
export const Name = styled.h2<{ past: boolean; itemprop: string }>`
...
export const MeetupDate = styled.p<{ itemprop: string; past: boolean }>`
  font-size: 1rem;
  color: ${(props) => props.theme.lightPurple};
  margin: 0 0 0.5em;
  font-weight: 400;
...
export const Host = styled.img<{ past: boolean }>`
  height: 1.75em;
  margin-top: 0.25em;
